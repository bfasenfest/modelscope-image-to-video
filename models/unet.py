...
from .resnet import ConditioningBlock
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.conditioning_in = ConditioningBlock(block_out_channels[0], block_out_channels[0])
        ...
        self.conditioning_out = ConditioningBlock(block_out_channels[0], block_out_channels[0])
    ...
    def forward(
        ...
        sample = self.conditioning_in(sample, num_frames=num_frames, init_image=init_image)
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(hidden_states=sample, temb=emb, num_frames=num_frames, init_image=init_image)
        ...
        sample = self.conditioning_out(sample, num_frames=num_frames, init_image=init_image)
    ...
    @classmethod
    def from_pretrained_3d(cls, pretrained_model_path, subfolder=None):
        ...
        for k, v in model_3d.state_dict().items():
            if 'conditioning_in' in k or 'conditioning_mid' in k or 'conditioning_out' in k:
